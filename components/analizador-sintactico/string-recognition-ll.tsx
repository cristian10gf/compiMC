...
/**
 * Componente para reconocimiento de cadenas en análisis sintáctico descendente
...
export function StringRecognitionLL({
  ...
  // Formatear contenido para copiar
          ...
          <>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-sm">Tabla de Análisis</h4>
                          ...
                          <TableCell>
                            <span
                              className={cn(
                                ...
                                step.action.includes('Match') && 'text-blue-600 dark:text-blue-400',
                                step.action.includes('Aplicar') && 'text-primary'
                              )}
                            >
                              {step.action}
                            </span>
